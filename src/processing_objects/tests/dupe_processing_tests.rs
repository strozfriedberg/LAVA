...
fn test_process_record_no_duplicate() {
    ...
    let record = make_fake_record(0, Some("2024-05-01 14:00:00"), StringRecord::from(vec!["test"]));
...
fn test_process_record_with_one_duplicate() {
    ...
    let record1 = make_fake_record(0, Some("2024-05-01 14:00:00"), StringRecord::from(vec!["test"]));
    let record2 = make_fake_record(0, Some("2024-05-01 14:00:00"), StringRecord::from(vec!["test45"]));
    let record3 = make_fake_record(0, Some("2024-05-01 14:00:00"), StringRecord::from(vec!["test45"]));
...
fn test_process_record_with_two_duplicate() {
    ...
    let record1 = make_fake_record(0, Some("2024-05-01 14:00:00"), StringRecord::from(vec!["test45"]));
    let record2 = make_fake_record(0, Some("2024-05-01 14:00:00"), StringRecord::from(vec!["test45"]));
    let record3 = make_fake_record(0, Some("2024-05-01 14:00:00"), StringRecord::from(vec!["test45"]));
    let _ = processor.process_record_for_dupes(&record1);
    let _ = processor.process_record_for_dupes(&record2);
